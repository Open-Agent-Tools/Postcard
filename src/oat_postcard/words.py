WORDS = [
    ...
    "earnest", "fearless", "fierce", "friendly", "happy", "honest", "humble",
    ...
    "ochre", "sepia", "magenta", "turquoise", "mauve", "cerulean", "maroon",
    ...
    "grove", "haven", "island", "journal", "kite", "ledger", "marina",
    "nebula", "orchard", "pillar", "quill", "reef", "signal", "tower",
    "valley", "whistle", "yacht", "zenith", "almanac", "barrel", "cipher",
    "diamond", "empire", "furnace", "gallery", "hollow", "ingot", "junction",
    "kindling",
]
